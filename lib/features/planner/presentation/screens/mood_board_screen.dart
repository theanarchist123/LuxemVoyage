...
class _MoodBoardScreenState extends State<MoodBoardScreen> {
  ...
  final List<Map<String, dynamic>> _moods = [
    ...
    {'label': 'Safari Sunsets',      'emoji': '🦁', 'color': const Color(0xFFB45309), 'img': 'https://images.unsplash.com/photo-1516426122078-c23e76319801?q=60&w=300'},
    {'label': 'Private Villas',      'emoji': '🏡', 'color': const Color(0xFF047857), 'img': 'https://images.unsplash.com/photo-1499793983690-e29da59ef1c2?q=60&w=300'},
    {'label': 'Historical Ruins',    'emoji': '🏺', 'color': const Color(0xFF92400E), 'img': 'https://images.unsplash.com/photo-1555990200-591eeb18be1e?q=60&w=300'},
    {'label': 'Coral Reefs',         'emoji': '🪸', 'color': const Color(0xFF0E7490), 'img': 'https://images.unsplash.com/photo-1544551763-46a013bb70d5?q=60&w=300'},
    {'label': 'Cozy Cabins',         'emoji': '🪵', 'color': const Color(0xFF78350F), 'img': 'https://images.unsplash.com/photo-1510798831971-661eb04b3739?q=60&w=300'},
    {'label': 'Modern Architecture', 'emoji': '🏙️', 'color': const Color(0xFF1F2937), 'img': 'https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?q=60&w=300'},
    {'label': 'Gourmet Dining',      'emoji': '🍽️', 'color': const Color(0xFF9D174D), 'img': 'https://images.unsplash.com/photo-1414235077428-33898bd1e6c5?q=60&w=300'},
    {'label': 'Wellness Spas',       'emoji': '🧖', 'color': const Color(0xFF0F766E), 'img': 'https://images.unsplash.com/photo-1544161515-4ab6ce6db874?q=60&w=300'},
    {'label': 'Cliffside Views',     'emoji': '🌊', 'color': const Color(0xFF1D4ED8), 'img': 'https://images.unsplash.com/photo-1516483638261-f40af5ff8f82?q=60&w=300'},
    {'label': 'Tropical Jungles',    'emoji': '🦜', 'color': const Color(0xFF15803D), 'img': 'https://images.unsplash.com/photo-1516026672322-bc52d61a55d5?q=60&w=300'},
    {'label': 'Hidden Enclaves',     'emoji': '🗝️', 'color': const Color(0xFF4338CA), 'img': 'https://images.unsplash.com/photo-1469854523086-cc02fe5d8800?q=60&w=300'},
    {'label': 'Art Festivals',       'emoji': '🎭', 'color': const Color(0xFFC026D3), 'img': 'https://images.unsplash.com/photo-1514525253161-7a46d19cd819?q=60&w=300'},
    {'label': 'Serene Lakes',        'emoji': '🛶', 'color': const Color(0xFF0369A1), 'img': 'https://images.unsplash.com/photo-1433838552652-f9a46b332c40?q=60&w=300'},
    {'label': 'Nomadic Tents',       'emoji': '⛺', 'color': const Color(0xFFC2410C), 'img': 'https://images.unsplash.com/photo-1506535995048-638aa1b62b77?q=60&w=300'},
    {'label': 'Yacht Cruising',      'emoji': '🛥️', 'color': const Color(0xFF0284C7), 'img': 'https://images.unsplash.com/photo-1569263979104-865ab7cd8d13?q=60&w=300'},
    {'label': 'Spiritual Retreats',  'emoji': '🧘', 'color': const Color(0xFF5B21B6), 'img': 'https://images.unsplash.com/photo-1505934333218-8fe31fbbc8ea?q=60&w=300'},
    {'label': 'Lush Valleys',        'emoji': '🏞️', 'color': const Color(0xFF166534), 'img': 'https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?q=60&w=300'},
    {'label': 'Bustling Bazaars',    'emoji': '🛍️', 'color': const Color(0xFFB91C1C), 'img': 'https://images.unsplash.com/photo-1533900298318-6b8da08a523e?q=60&w=300'},
  ];
